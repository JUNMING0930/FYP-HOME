			...
			<form class="file-upload" action="profilecode.php" method="POST">
					...
					<div class="col-xxl-8 mb-5 mb-xxl-0">
						<div class="bg-secondary-soft px-4 py-5 rounded">
							<div class="row ">
                                ...
                                <input type="password" name="opassword"size="50" style="border:none;background-color:rgba(208, 212, 217, 0)!important;font-size:20px" value="<?php echo $User_Info['User_Password']?>"></input>
								</div>
                                <!-- New Password -->
								<div class="col-md-8">
                ...
                */
				...
				<div class="col-md-6">
					...
					<a href="editprofile.php?id=<?php echo $User_Info['ID']?>" class="btn btn-danger btn-lg">Return</a>
				</div>
				<?php
				?>
			</form> <!-- Form END -->    
